...
*/
Glace18_3(document).ready(function($) {
...
function change_text(type){
	if(type == 1){
		var w_td = Glace18_3('#size_width').parent();
		var w_tr = w_td.parent();
		var w_label = w_tr.find("td label");
		w_label.html("Grid Width");
		
		var h_td = Glace18_3('#size_height').parent();
...
function change_transaction(){
	...
	Glace18_3(".sel_trans").each(function () {
		var value	=	Glace18_3(this).val();
		var parent	=	Glace18_3(this).parent(0);
		parent.find(".show_trans").addClass('trans_'+value);
	});

	Glace18_3("select.sel_trans").bind("change", function() {
		var tmp_sel	=	Glace18_3(this);
